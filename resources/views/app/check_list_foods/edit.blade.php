    ...
    <section aria-labelledby="hire-contract">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <x-slot name="title">
                ...
                ></a>
                @lang('crud.check_list_foods.edit_title')
            </x-slot>
            
            <x-form
                method="PUT"
                action="{{ route('check-list-foods.update', $checkListFood) }}"
                class="mt-4 parentForm"
                enctype="multipart/form-data"
                id="check-list-foods-edit-form"
            >
                ...
                <div class="mt-10">
                    ...
                    <a href="{{ route('check-list-foods.create') }}" class="button">
                        <i class="mr-1 icon ion-md-add text-primary"></i>
                        Save
                    </a>
                    @if(!isset($url_link) && $checkListFood->status != 'signed')
