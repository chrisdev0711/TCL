    ...
    <section aria-labelledby="hire-contract">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <x-slot name="title">
                ...
                ></a>
                @lang('crud.check_list_n_rs.edit_title')
            </x-slot>
            
            <x-form
            method="PUT"
            action="{{ route('check-list-n-rs.update', $checkListNr) }}"
            class="mt-4 parentForm"
            enctype="multipart/form-data"                
            id="check-list-nrs-edit-form"
            >
            ...
            <div class="mt-10">
                <a href="{{ route('hires.index') }}" class="button">
                    ...
                    @if(!isset($url_link) && $checkListNr->status != 'signed')
