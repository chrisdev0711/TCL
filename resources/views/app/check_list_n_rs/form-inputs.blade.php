                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListNr->status == 'signed' ? 'disabled' : ''}}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing && $checkListNr->status == 'signed' ? 'disabled' : ''}}
                                            />
                                            <label for="dipstrick" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing && $checkListNr->status == 'signed' ? 'disabled' : ''}}
                                            />
                                            <label for="handrail_ladder" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing && $checkListNr->status == 'signed' ? 'disabled' : ''}}
                                            />
                                            <label for="engine" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="grid grid-cols-6 gap-6 pb-6">
                    ...
                    {{$editing && $checkListNr->status == 'signed' ? 'disabled' : ''}} name = "int_video" id = "int_video_form"  value = "{{ old('int_video', ($editing ? $checkListNr->int_video : '')) }}" hidden>
                    ...
                    <input {{$url_link ? 'disabled' : ''}}
                    {{$editing && $checkListNr->status == 'signed' ? 'disabled' : ''}} name = "ext_video" id = "ext_video_form" value = "{{ old('ext_video', ($editing ? $checkListNr->ext_video : '')) }}" hidden>
                    {{-- Column 4 100%--}}
                    <div class="col-span-6 sm:col-span-6">
                    ...
                    <div class="col-md-12 d-flex align-items-center justify-content-center">
                        <div class="mt-1 border border-gray-200">
                            <img id="cleaning_status_image" class="mx-auto"
                                src="{{old('cleaning_status', $editing ? ($checkListNr->cleaning_status && str_contains($checkListNr->cleaning_status, '/')) ? asset($checkListNr->cleaning_status) : '/img/camera_icon.png' : '/img/camera_icon.png')}}" alt="cleaning_status_image">
                        ...
                        <div class="flex items-center" x-data="{ on: false }">
                            <div class="toggle colour">
                                <input
                                    ...
                                    type="checkbox"
                                    name = "cleaning_check"
                                    {{$editing ? $checkListNr->cleaning_check == true ? 'checked' : '' : ''}}
                                    {{$url_link ? 'disabled' : ''}}
                                    {{$editing && $checkListNr->status == 'signed' ? 'disabled' : ''}}
                                />
        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                    <a id = "left-side" class={{ $editing && $checkListNr->status == 'signed' ? 'disabled-link' : '' }}>
                        <img id="left-side-image" class="mx-auto" src="{{$editing ? asset($checkListNr->ext_splat_left) : asset($hire->tanker->ext_splat_left)}}" alt="left-side-image">
                    </a>
                    @else
                    <img id="left-side-image" class="mx-auto" src="{{$editing ? asset($checkListNr->ext_splat_left) : asset($hire->tanker->ext_splat_left)}}" alt="left-side-image">
                    @endif
                    <input
                    {{$url_link ? 'disabled' : ''}}
                    id = "left-side-image-form" name = 'ext_splat_left' hidden value = "{{$editing ? $checkListNr->ext_splat_left : $hire->tanker->ext_splat_left}}"/>
                </div>
            </div>
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                    <a id = "front-side" class={{ $editing && $checkListNr->status == 'signed' ? 'disabled-link' : '' }}>
                        <img id="front-side-image"
                            class="mx-auto"
                            src="{{$editing ? asset($checkListNr->ext_splat_front) : asset($hire->tanker->ext_splat_front)}}" alt="front-side-image">
                    </a>
                    @else
                    <img id="front-side-image"
                            class="mx-auto"
                    ...
                    <input
                    {{$url_link ? 'disabled' : ''}}
                    id = "front-side-image-form" name = 'ext_splat_front' hidden value = "{{$editing ? $checkListNr->ext_splat_front : $hire->tanker->ext_splat_front}}" />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                    <a id = "back-side" class={{ $editing && $checkListNr->status == 'signed' ? 'disabled-link' : '' }}>
                        <img id="back-side-image"
                            class="mx-auto"
                            src="{{$editing ? asset($checkListNr->ext_splat_rear) : asset($hire->tanker->ext_splat_rear)}}" alt="back-side-image">
                    </a>
                    @else
                    <img id="back-side-image"
                            class="mx-auto"
                    ...
                    <input
                        ...
                        value = "{{$editing ? $checkListNr->ext_splat_rear : $hire->tanker->ext_splat_rear}}"
                    />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)    
                    <a id = "right-side" class={{ $editing && $checkListNr->status == 'signed' ? 'disabled-link' : '' }}>
                        <img id="right-side-image" class="mx-auto"
                            src="{{$editing ? asset($checkListNr->ext_splat_right) : asset($hire->tanker->ext_splat_right)}}"
                    ...
                    <input
                        ...
                        value = "{{$editing ? $checkListNr->ext_splat_right : $hire->tanker->ext_splat_right}}"
                    />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                        <a id = "internal" class={{ $editing && $checkListNr->status == 'signed' ? 'disabled-link' : '' }}>
                            <img id="internal-image"
                                class="mx-auto"
                                src="{{$editing ? asset($checkListNr->int_splat) : asset($hire->tanker->int_splat)}}" alt="internal-image">
                        </a>
                    @else
                    <img id="internal-image"
                                class="mx-auto"
                    ...
                    <input
                        ...
                        value = "{{$editing ? $checkListNr->int_splat : $hire->tanker->int_splat}}"
                    />
                </div>
            </div>
...
@include('components.section.signature-form', [
    ...
    'checklist_editable' => $editing && $checkListNr->status == 'signed' ? true : false
])
@if($editing)
...
<script>
    ...
    var checkListObj = {!! json_encode($editing ? $checkListNr : null) !!}
    var flg = "n_rs";
