    ...
    <section aria-labelledby="hire-contract">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <x-slot name="title">
                ...
                ></a>
                @lang('crud.check_list_milks.edit_title')
            </x-slot>
            
            <x-form
                method="PUT"
                action="{{ route('check-list-milks.update', $checkListMilk) }}"
                class="mt-4 parentForm"
                enctype="multipart/form-data"  
                id="check-list-milks-edit-form"              
            >
                ...
                <div class="mt-10">
                    ...
                    @if(!isset($url_link) && $checkListMilk->status != 'signed')
