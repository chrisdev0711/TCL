                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListPetrol->cladding_panels == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                class="hidden toggle-checkbox"
                                                type="checkbox"
                                                name = "ladder_handrail"
                                                {{$editing ? $checkListPetrol->ladder_handrail == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                            <label for="ladder_handrail" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                            <span class="text-sm font-medium text-gray-900">Ladder / Handrail</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "side_guards"
                                                {{$editing ? $checkListPetrol->side_guards == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "rear_bumper"
                                                {{$editing ? $checkListPetrol->rear_bumper == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                        ...
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                            <span class="text-sm font-medium text-gray-900">Rear Pump</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "wings_stays"
                                                {{$editing ? $checkListPetrol->wings_stays == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "dipstick"
                                                {{$editing ? $checkListPetrol->dipstick == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                            <label for="dipstick" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "lights"
                                                {{$editing ? $checkListPetrol->lights == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListPetrol->fire_extinguisher == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                            <label for="fire_extinguisher" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                            <span class="text-sm font-medium text-gray-900">Fire Extinguisher</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "chassis"
                                                {{$editing ? $checkListPetrol->chassis == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListPetrol->valve_operation == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListPetrol->compartment_internal == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                            ...
                            <div class="flex items-center">
                                <div class="w-full max-w-xl -mx-auto">
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                id="landingLegs_operation"
                                                class="hidden toggle-checkbox"
                                                type="checkbox"
                                                name = "landingLegs_operation"
                                                {{$editing ? $checkListPetrol->landingLegs_operation == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                            <label for="landingLegs_operation" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                            <span class="text-sm font-medium text-gray-900">Landing Legs / Operation</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <div class="w-full max-w-xl -mx-auto">
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                id="dischargePump_operation"
                                                class="hidden toggle-checkbox"
                                                type="checkbox"
                                                name = "dischargePump_operation"
                                                {{$editing ? $checkListPetrol->dischargePump_operation == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                            />
                                            <label for="dischargePump_operation" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                            <span class="text-sm font-medium text-gray-900">DischargePump / operation</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        <div class="">
                            ...
                            <textarea
                                ...
                                {{$url_link ? 'disabled' : ''}}
                                {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                >{{$editing ? $checkListPetrol->vehicle_check_note : ''}}</textarea>
                            </div>
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="grid grid-cols-6 gap-6 pb-6">
                    {{-- Column 1 33.3% --}}
                    <script>
                        var int_video_source = "{{ old('int_video', ($editing ? $checkListPetrol->int_video : '')) }}";
                        var ext_video_source = "{{ old('ext_video', ($editing ? $checkListPetrol->ext_video : '')) }}";
                    </script>

                    <div class="col-span-6 align-top sm:col-span-3" style="height : 210px">
                        <video-tag id="internal-video-tag" ></video-tag>
                    </div>
                    {{-- <input  {{$url_link ? 'disabled' : ''}}
                    {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}} name = "int_video" id = "int_video_form"  value = "{{ old('int_video', ($editing ? $checkListPetrol->int_video : '')) }}" hidden> --}}
                    <input name = "int_video" id = "int_video_form"  value = "{{ old('int_video', ($editing ? $checkListPetrol->int_video : '')) }}" hidden>
                    ...
                    {{-- <input {{$url_link ? 'disabled' : ''}}
                    {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}} name = "ext_video" id = "ext_video_form" value = "{{ old('ext_video', ($editing ? '/storage/'.$checkListPetrol->ext_video : '')) }}" hidden> --}}
                    <input name = "ext_video" id = "ext_video_form" value = "{{ old('ext_video', ($editing ? $checkListPetrol->ext_video : '')) }}" hidden>
                    {{-- Column 4 100%--}}
                    <div class="col-span-6 sm:col-span-6">
                    ...
                    <div class="col-md-12 d-flex align-items-center justify-content-center">
                        <div class="mt-1 border border-gray-200">
                            <img id="cleaning_status_image" class="mx-auto"
                                src="{{old('cleaning_status', $editing ? ($checkListPetrol->cleaning_status && str_contains($checkListPetrol->cleaning_status, '/')) ? asset($checkListPetrol->cleaning_status) : '/img/camera_icon.png' : '/img/camera_icon.png')}}" alt="cleaning_status_image">
                            <input type="file" id="cleaning_status_image_form" name = 'cleaning_status' hidden
                            value = "{{old('cleaning_status', $editing ? $checkListPetrol->cleaning_status : '/img/tanker.jpg')}}" accept="image/*"/>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex items-center" x-data="{ on: false }">
                            <div class="toggle colour">
                                <input
                                    ...
                                    type="checkbox"
                                    name = "cleaning_check"
                                    {{$editing ? $checkListPetrol->cleaning_check == true ? 'checked' : '' : ''}}
                                    {{$url_link ? 'disabled' : ''}}
                                    {{$editing && $checkListPetrol->status=='signed' ? 'disabled' : ''}}
                                />
                                    ...
                                    <div class="flex-1 w-1/2 min-w-0">
                                        @if ($url_link)
                                            <input
                                                type="text"
                                                name="ns_1"
                                                value="{{ old('ns_1', ($editing ? $checkListPetrol->ns_1 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                disabled
                                    ...
                                    <div class="flex-1 min-w-0">
                                        @if ($url_link)
                                            <input
                                                type="text"
                                                name="os_1"
                                                value="{{ old('os_1', ($editing ? $checkListPetrol->os_1 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                disabled
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                    ...
                                    <div class="flex-1 w-1/2 min-w-0">
                                        @if($url_link)
                                            <input
                                                type="text"
                                                name="ns_2"
                                                value="{{ old('ns_2', ($editing ? $checkListPetrol->ns_2 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                                {{ $editing && $checkListPetrol->status == 'signed' ? 'disabled' : ''}}
                                    ...
                                    <div class="flex-1 min-w-0">
                                        @if($url_link)
                                            <input
                                                type="text"
                                                name="os_2"
                                                value="{{ old('os_2', ($editing ? $checkListPetrol->os_2 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                disabled
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                    ...
                                    <div class="flex-1 w-1/2 min-w-0">
                                        @if($url_link)
                                            <input
                                                type="text"
                                                name="ns_3"
                                                value="{{ old('ns_3', ($editing ? $checkListPetrol->ns_3 : '')) }}"
                                                maxlength="255"
                                                disabled
                                                placeholder="mm"
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        @if ($url_link)
                                            <input
                                                type="text"
                                                name="os_3"
                                                value="{{ old('os_3', ($editing ? $checkListPetrol->os_3 : '')) }}"
                                                maxlength="255"
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                                placeholder="mm"
                                                disabled
        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                    <a id = "left-side" class={{ $editing && $checkListPetrol->status="signed" ? 'disabled-link' : '' }}>
                        <img id="left-side-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->ext_splat_left) : asset($hire->tanker->ext_splat_left)}}" alt="left-side-image">
                    </a>
                    @else
                        <img id="left-side-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->ext_splat_left) : asset($hire->tanker->ext_splat_left)}}" alt="left-side-image">
                    @endif
                    <input
                    id = "left-side-image-form" name = 'ext_splat_left' hidden value = "{{$editing ? $checkListPetrol->ext_splat_left : $hire->tanker->ext_splat_left}}"/>
                </div>
            </div>
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                    <a id = "front-side" class={{ $editing && $checkListPetrol->status="signed" ? 'disabled-link' : '' }}>
                        <img id="front-side-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->ext_splat_front) : asset($hire->tanker->ext_splat_front)}}" alt="front-side-image">
                    </a>
                    @else
                    <img id="front-side-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->ext_splat_front) : asset($hire->tanker->ext_splat_front)}}" alt="front-side-image">
                    @endif
                    <input
                    id = "front-side-image-form" name = 'ext_splat_front' hidden value = "{{$editing ? $checkListPetrol->ext_splat_front : $hire->tanker->ext_splat_front}}" />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                        <a id = "back-side" class={{ $editing && $checkListPetrol->status="signed" ? 'disabled-link' : '' }}>
                            <img id="back-side-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->ext_splat_rear) : asset($hire->tanker->ext_splat_rear)}}" alt="back-side-image">
                        </a>
                    @else
                        <img id="back-side-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->ext_splat_rear) : asset($hire->tanker->ext_splat_rear)}}" alt="back-side-image">
                    @endif
                    <input
                        ...
                        value = "{{$editing ? $checkListPetrol->ext_splat_rear : $hire->tanker->ext_splat_rear}}"
                    />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                        <a id = "right-side" class={{ $editing && $checkListPetrol->status="signed" ? 'disabled-link' : '' }}>
                            <img id="right-side-image" class="mx-auto"
                            src="{{$editing ? asset($checkListPetrol->ext_splat_right) : asset($hire->tanker->ext_splat_right)}}"
                    ...
                    <input
                        ...
                        value = "{{$editing ? $checkListPetrol->ext_splat_right : $hire->tanker->ext_splat_right}}"
                    />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                        <a id = "internal" class={{ $editing && $checkListPetrol->status="signed" ? 'disabled-link' : '' }}>
                            <img id="internal-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->int_splat) : asset($hire->tanker->int_splat)}}" alt="internal-image">
                        </a>
                    @else
                        <img id="internal-image" class="mx-auto" src="{{$editing ? asset($checkListPetrol->int_splat) : asset($hire->tanker->int_splat)}}" alt="internal-image">
                    @endif
                    <input
                        ...
                        value = "{{$editing ? $checkListPetrol->int_splat : $hire->tanker->int_splat}}"
                    />
                </div>
            </div>
        </div>
...
@include('components.section.signature-form', [
    'editing' => $editing,
    'data' => $editing ? $checkListPetrol : null,
    'contract_editable' => $url_link,
    'checklist_editable' => $editing && $checkListPetrol->status=="signed" ? true : false
])
@if($editing)
...
<script>
    ...
    var checkListObj = {!! json_encode($editing ? $checkListPetrol : null) !!}
    var flg = "petrols";
