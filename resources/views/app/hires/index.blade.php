                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 text-left">
                                {{ optional($hire->contact->company->company) ?? '-' }}
                            </td>
                            <td class="px-4 py-3 text-left">
                ...
                <div class="flex items-center px-4 py-4 sm:px-6">
                    <div class="min-w-0 flex-1 flex items-center">
                        <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                            <div>
                                <p class="text-base font-medium text-cyan-600">{{ $hire->contact->company->company }} - {{ $hire->contact->contact }}</p>
                                <p class="mt-2 flex items-center text-sm text-gray-500">
                                    <span class="font-semibold mr-1">Fleet Num:</span><span class="">{{ optional($hire->tanker)->fleet_num ?? '-' }}</span><span class="font-semibold ml-4 mr-1">Contract:</span><span class="">{{$hire->contract_num ?? '-'}}</span>
                                </p>
                            </div>
                            <div class="hidden">
                            ...
                            <div class="hidden md:block">
                                <div>
                                    ...
                                    Start
                                    <time class="ml-1 mr-12 text-gray-600" datetime="2020-01-07">{{ optional($hire->start_date)->format('dS M Y') ?? '-' }}</time>
                                    End
                                    <time class="ml-1 text-gray-600" datetime="2020-01-07">{{ optional($hire->end_date)->format('dS M Y') ?? '-' }}</time>
                                    </p>
                                    <p class="mt-2 flex items-center text-sm text-gray-500">
