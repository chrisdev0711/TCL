            ...
            <div class="bg-white p-6">
              ...
              <div class="mt-4 mb-10 relative">                                                                                               
                    ...
                    <a
                        ...
                        class="bg-green-500 hover:bg-green-700 text-white text-sm border-none py-1.5 px-4 rounded-md float-right mr-4"
                    >                                
                    ...
                    @can('create', App\Models\Tanker::class)
                    <a
                        href="{{ route('excel.importView') }}"
                        class="button button-primary float-right py-1 px-4 mr-4 border-none"
                    >
                        <i class="mr-1 icon ion-md-cloud-upload"></i>
                        @lang('crud.common.upload')
                    </a>
                    @endcan                                                                       
            </div>
