    ...
    <section aria-labelledby="hire-contract">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <x-slot name="title">
                ...
                ></a>
                @lang('crud.check_list_wastes.create_title')
            </x-slot>

            <form
                method="POST"
                action="{{ route('check-list-wastes.store') }}"
                role="form"
                class="mt-4"
                enctype="multipart/form-data"
                id="check-list-wastes-form"
            >
                ...
                <div class="mt-10">
                    ...
                    <a id="abort_waste_btn" class="bg-orange-500 hover:bg-orange-700 text-white py-1 px-4 rounded-md float-left ml-5 mr-5 cursor-pointer">
