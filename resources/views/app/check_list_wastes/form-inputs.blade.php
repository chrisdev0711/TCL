                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListWaste->ladder_handrail == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "side_guards"
                                                {{$editing ? $checkListWaste->side_guards == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "rear_bumper"
                                                {{$editing ? $checkListWaste->rear_bumper == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "wings_stays"
                                                {{$editing ? $checkListWaste->wings_stays == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "vacuum_pump"
                                                {{$editing ? $checkListWaste->vacuum_pump == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "lights"
                                                {{$editing ? $checkListWaste->lights == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListWaste->fire_extinguisher == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                class="hidden toggle-checkbox"
                                                type="checkbox"
                                                name = "engine_operation"
                                                {{$editing ? $checkListWaste->engine_operation == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                            <label for="engine_operation" class="block w-12 h-6 duration-150 ease-out rounded-full toggle-label transition-color"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                            <span class="text-sm font-medium text-gray-900">Engine/Operation</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListWaste->valve_operation == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListWaste->compartment_internal == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$editing ? $checkListWaste->landingLegs_operation == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                                        ...
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
                                            <span class="text-sm font-medium text-gray-900">LandingLegs/Operation</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                type="checkbox"
                                                name = "chassis"
                                                {{$editing ? $checkListWaste->chassis == true ? 'checked' : '' : ''}}
                                                {{$url_link ? 'disabled' : ''}}
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                            />
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        <div class="">
                            ...
                            <textarea
                                ...
                                {{$url_link ? 'disabled' : ''}}
                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                >{{$editing ? $checkListWaste->vehicle_check_note : ''}}</textarea>
                            </div>
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="grid grid-cols-6 gap-6 pb-6">
                    {{-- Column 1 33.3% --}}
                    <script>
                        var int_video_source = "{{ old('int_video', ($editing ? $checkListWaste->int_video : '')) }}";
                        var ext_video_source = "{{ old('ext_video', ($editing ? $checkListWaste->ext_video : '')) }}";
                    </script>
                    ...
                    {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }} name = "int_video" id = "int_video_form"  value = "{{ old('int_video', ($editing ? $checkListWaste->int_video : '')) }}" hidden>
                    ...
                    <input {{$url_link ? 'disabled' : ''}}
                    {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }} name = "ext_video" id = "ext_video_form" value = "{{ old('ext_video', ($editing ? $checkListWaste->ext_video : '')) }}" hidden>
                    {{-- Column 4 100%--}}
                    <div class="col-span-6 sm:col-span-6">
                    ...
                    <div class="col-md-12 d-flex align-items-center justify-content-center">
                        <div class="mt-1 border border-gray-200">
                            <img id="cleaning_status_image" class="mx-auto"
                                src="{{old('cleaning_status', $editing ? ($checkListWaste->cleaning_status && str_contains($checkListWaste->cleaning_status, '/')) ? asset($checkListWaste->cleaning_status) : '/img/camera_icon.png' : '/img/camera_icon.png')}}" alt="cleaning_status_image">
                            <input type="file" id="cleaning_status_image_form" name = 'cleaning_status' hidden
                            value = "{{old('cleaning_status', $editing ? $checkListWaste->cleaning_status : '/img/tanker.jpg')}}" accept="image/*"/>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex items-center" x-data="{ on: false }">
                            <div class="toggle colour">
                                <input
                                    ...
                                    type="checkbox"
                                    name = "cleaning_check"
                                    {{$editing ? $checkListWaste->cleaning_check == true ? 'checked' : '' : ''}}
                                    {{$url_link ? 'disabled' : ''}}
                                    {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                />
                                    ...
                                    <div class="flex-1 w-1/2 min-w-0">                                        
                                        @if ($url_link)
                                            <input
                                                type="text"
                                                name="ns_1"
                                                value="{{ old('ns_1', ($editing ? $checkListWaste->ns_1 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                disabled
                                    ...
                                    <div class="flex-1 min-w-0">                                        
                                        @if ($url_link)
                                            <input
                                                type="text"
                                                name="os_1"
                                                value="{{ old('os_1', ($editing ? $checkListWaste->os_1 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                disabled
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                    ...
                                    <div class="flex-1 w-1/2 min-w-0">                                        
                                        @if($url_link)
                                            <input
                                                type="text"
                                                name="ns_2"
                                                value="{{ old('ns_2', ($editing ? $checkListWaste->ns_2 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                                {{ $editing && $checkListWaste->status == 'signed' ? 'disabled' : '' }}
                                    ...
                                    <div class="flex-1 min-w-0">                                        
                                        @if($url_link)
                                            <input
                                                type="text"
                                                name="os_2"
                                                value="{{ old('os_2', ($editing ? $checkListWaste->os_2 : '')) }}"
                                                maxlength="255"
                                                placeholder="mm"
                                                disabled
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                    ...
                                    <div class="flex-1 w-1/2 min-w-0">                                       
                                        @if($url_link)
                                            <input
                                                type="text"
                                                name="ns_3"
                                                value="{{ old('ns_3', ($editing ? $checkListWaste->ns_3 : '')) }}"
                                                maxlength="255"
                                                disabled
                                                placeholder="mm"
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                    ...
                                    <div class="flex-1 min-w-0">                                       
                                        @if ($url_link)
                                            <input
                                                type="text"
                                                name="os_3"
                                                value="{{ old('os_3', ($editing ? $checkListWaste->os_3 : '')) }}"
                                                maxlength="255"
                                                class="relative block w-full py-2 bg-transparent border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-br-md focus:z-10 sm:text-sm"
                                                placeholder="mm"
                                                disabled
        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                    <a id = "left-side" class={{ $editing && $checkListWaste->status == 'signed' ? 'disabled-link' : '' }}>
                        <img id="left-side-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->ext_splat_left) : asset($hire->tanker->ext_splat_left)}}" alt="left-side-image">
                    </a>
                    @else
                    <img id="left-side-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->ext_splat_left) : asset($hire->tanker->ext_splat_left)}}" alt="left-side-image">
                    @endif
                    <input
                    {{$url_link ? 'disabled' : ''}}
                    id = "left-side-image-form" name = 'ext_splat_left' hidden value = "{{$editing ? $checkListWaste->ext_splat_left : $hire->tanker->ext_splat_left}}"/>
                </div>
            </div>
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                    <a id = "front-side"><img id="front-side-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->ext_splat_front) : asset($hire->tanker->ext_splat_front)}}" alt="front-side-image"></a class={{ $editing && $checkListWaste->status == 'signed' ? 'disabled-link' : '' }}>
                    @else
                    <img id="front-side-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->ext_splat_front) : asset($hire->tanker->ext_splat_front)}}" alt="front-side-image">
                    @endif
                    <input
                    {{$url_link ? 'disabled' : ''}}
                    id = "front-side-image-form" name = 'ext_splat_front' hidden value = "{{$editing ? $checkListWaste->ext_splat_front : $hire->tanker->ext_splat_front}}" />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                        <a id = "back-side"><img id="back-side-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->ext_splat_rear) : asset($hire->tanker->ext_splat_rear)}}" alt="back-side-image"></a class={{ $editing && $checkListWaste->status == 'signed' ? 'disabled-link' : '' }}>
                    @else
                    <img id="back-side-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->ext_splat_rear) : asset($hire->tanker->ext_splat_rear)}}" alt="back-side-image">
                    @endif
                    <input
                        {{$url_link ? 'disabled' : ''}}
                        id = "back-side-image-form" name = 'ext_splat_rear' hidden
                        value = "{{$editing ? $checkListWaste->ext_splat_rear : $hire->tanker->ext_splat_rear}}"
                    />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                        <a id = "right-side"><img id="right-side-image" class="mx-auto class={{ $editing && $checkListWaste->status == 'signed' ? 'disabled-link' : '' }}"
                            src="{{$editing ? asset($checkListWaste->ext_splat_right) : asset($hire->tanker->ext_splat_right)}}"
                    ...
                    <input
                        ...
                        value = "{{$editing ? $checkListWaste->ext_splat_right : $hire->tanker->ext_splat_right}}"
                    />
                </div>
            </div>
            ...
            <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                <div class="box-content border-2 border-gray-300 rounded">
                    @if(!$url_link)
                        <a id = "internal"><img id="internal-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->int_splat) : asset($hire->tanker->int_splat)}}" alt="internal-image"></a class={{ $editing && $checkListWaste->status == 'signed' ? 'disabled-link' : '' }}>
                    @else
                    <img id="internal-image" class="mx-auto" src="{{$editing ? asset($checkListWaste->int_splat) : asset($hire->tanker->int_splat)}}" alt="internal-image">
                    @endif
                    <input
                        {{$url_link ? 'disabled' : ''}}
                        id = "internal-image-form" name = 'int_splat' hidden
                        value = "{{$editing ? $checkListWaste->int_splat : $hire->tanker->int_splat}}"
                    />
                </div>
            </div>
...
@include('components.section.signature-form', [
    'editing' => $editing,
    'data' => $editing ? $checkListWaste : null,
    'contract_editable' => $url_link,
    'checklist_editable' => $editing && $checkListWaste->status == 'signed' ? true : false
])
@if($editing)
...
<script>
    ...
    var flg = "wastes";
    var checkListObj = {!! json_encode($editing ? $checkListWaste : null) !!}
