    ...
    <div class="min-h-screen flex" style="background-color:#19A5B4;">
        ...
        <div class="mx-auto w-full max-w-sm lg:w-96">
           ...
           <h2 class="mt-6 text-3xl font-extrabold text-gray-900">
                If you're looking for tanker hire, please visit our main web site here:<br /> <a  class="mt-6 text-3xl font-extrabold text-white underline"href="https://www.tcl-tankers.com">tcl-tankers.com</a>
            </h2>
            <h2 class="mt-6 text-2xl font-extrabold text-gray-900">
                Click 'Sign in' to view the dashboard.
            </h2>
        </div>
