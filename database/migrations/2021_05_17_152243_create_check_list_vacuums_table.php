...
class CreateCheckListVacuumsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('check_list_vacuums', function (Blueprint $table) {
            $table->timestamps();
            ...
            $table->boolean('engine_operation')->default(0);
            $table->boolean('vacuum_pump')->default(0);
    ...
    {
        Schema::dropIfExists('check_list_vacuums');
    }
}
