...
class CreateCheckListPetrolsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('check_list_petrols', function (Blueprint $table) {
            ...
            $table->boolean('dischargePump_operation')->default(0); 
    ...
    {
        Schema::dropIfExists('check_list_petrols');
    }
}
