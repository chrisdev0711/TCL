...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list checklistmilks']);
        Permission::create(['name' => 'view checklistmilks']);
        Permission::create(['name' => 'create checklistmilks']);
        Permission::create(['name' => 'update checklistmilks']);
        Permission::create(['name' => 'delete checklistmilks']);
        
        Permission::create(['name' => 'list checklistfoods']);
        Permission::create(['name' => 'view checklistfoods']);
        Permission::create(['name' => 'create checklistfoods']);
        Permission::create(['name' => 'update checklistfoods']);
        Permission::create(['name' => 'delete checklistfoods']);
        
        Permission::create(['name' => 'list checklistvacuums']);
        Permission::create(['name' => 'view checklistvacuums']);
        Permission::create(['name' => 'create checklistvacuums']);
        Permission::create(['name' => 'update checklistvacuums']);
        Permission::create(['name' => 'delete checklistvacuums']);
        
        Permission::create(['name' => 'list checklistwastes']);
        Permission::create(['name' => 'view checklistwastes']);
        Permission::create(['name' => 'create checklistwastes']);
        Permission::create(['name' => 'update checklistwastes']);
        Permission::create(['name' => 'delete checklistwastes']);

        Permission::create(['name' => 'list checklistpetrols']);
        Permission::create(['name' => 'view checklistpetrols']);
        Permission::create(['name' => 'create checklistpetrols']);
        Permission::create(['name' => 'update checklistpetrols']);
        Permission::create(['name' => 'delete checklistpetrols']);
